...
Second, these constructs were iteratively abstracted and synthesized into six motivational dimensions: Growth, Resolution, Coherence, Creation, Contribution, and Autonomy. Each dimension represents a class of intrinsically rewarding experiences that recur across theories but are rarely unified within software engineering research. Table~\ref{tab:construct-mapping} makes this mapping explicit by showing, for each motivational dimension, the primary theoretical constructs that informed its formulation and the conceptual rationale linking them.

\begin{table}[t]
\centering
\caption{Mapping from raw theoretical constructs to motivational dimensions. For each dimension, the table lists the primary constructs that informed its formulation and the conceptual rationale linking them.}
\label{tab:construct-mapping}
\footnotesize
\begin{tabularx}{\linewidth}{l l X}
\toprule
\textbf{Dimension} & \textbf{Informing Constructs} & \textbf{Rationale} \\
\midrule

Growth & 
Mastery orientation; competence; challenge--skill balance; sensitivity to feedback; reward responsiveness &
These constructs converge on the experience of expanding one's capabilities. Mastery orientation and competence describe the drive to improve; challenge--skill balance specifies the conditions under which such improvement is experienced as engaging rather than overwhelming; feedback sensitivity determines how strongly progress signals are registered. \\[3pt]

Resolution & 
Goal-directed behavior; problem-solving strategies; analytic reasoning; persistence profiles; approach--avoidance tendencies &
Resolution captures the satisfaction of reducing ambiguity and achieving closure. Goal-directed behavior and problem-solving strategies describe the cognitive orientation toward convergence; analytic reasoning favors decomposition and clarity; persistence profiles determine tolerance for sustained effort toward a solution. \\[3pt]

Coherence & 
Systemizing; coherence seeking; abstraction preference; holistic reasoning; representational alignment &
These constructs jointly describe a sensitivity to structural integrity. Systemizing and coherence seeking reflect a preference for integrated wholes; abstraction preference captures comfort with multi-level reasoning; representational alignment links internal schemata to external structures. \\[3pt]

Creation & 
Intrinsic motivation (generative); reward responsiveness (novelty); exploratory problem-solving; technological appropriation &
Creation synthesizes constructs related to the production of novelty. Intrinsic motivation in its generative aspect drives the impulse to produce; novelty-oriented reward responsiveness sustains engagement with open-ended tasks; exploratory problem-solving describes the preferred mode of action. \\[3pt]

Contribution & 
Relatedness; approach tendencies (prosocial); reinforcement history (collaborative success) &
Contribution aggregates constructs oriented toward impact on others. Relatedness captures the need for meaningful social connection; prosocial approach tendencies motivate helping behavior; collaborative reinforcement history shapes sensitivity to team-oriented rewards. \\[3pt]

Autonomy & 
Autonomy (SDT); sense of control; avoidance tendencies (constraint aversion); exploratory problem-solving &
Autonomy integrates constructs related to self-direction. The SDT construct of autonomy provides the core; sense of control from flow theory specifies the experiential quality; constraint aversion describes what disrupts it; exploratory problem-solving reflects the preferred mode of self-directed work. \\
\bottomrule
\end{tabularx}
\end{table}
...
To illustrate this refinement process, we describe four representative cases of candidate profiles that were eliminated or merged during synthesis.

\begin{itemize}
\item \textit{Perfectionist} (eliminated for incoherence). This candidate combined dominant Coherence with dominant Resolution, reflecting a drive for both structural elegance and problem closure. However, in practice these two orientations frequently conflict: the pursuit of structural perfection resists the pragmatic convergence required by resolution. The profile was judged internally unstable because the two dominant drives would generate chronic tension rather than a stable experiential pathway. The relevant motivational tendencies were redistributed across the Architect (Coherence-dominant) and Solver (Resolution-dominant) archetypes.

\item \textit{Maverick} (eliminated for incoherence). This candidate paired dominant Autonomy with dominant Contribution, representing a practitioner motivated simultaneously by independence and team impact. These orientations are not logically contradictory, but the conditions under which each produces joy are substantially different: Autonomy requires minimal external constraints, while Contribution requires sustained engagement with others' needs. No stable ``joy signature'' could be identified. The relevant tendencies were captured separately by the Autonomist and Helper archetypes.

\item \textit{Craftsman} (merged with Builder). This candidate emphasized Creation with strong Coherence, representing careful, quality-oriented production. During evaluation, the Craftsman's motivational profile was found to overlap extensively with the Builder when Coherence was treated as tertiary rather than secondary. The distinguishing feature---attention to aesthetic quality---was not sufficiently grounded in a distinct motivational mechanism to justify a separate archetype.

\item \textit{Mentor} (merged with Helper). This candidate was Contribution-dominant with secondary Growth, representing a practitioner who finds joy in developing others' skills. While conceptually appealing, the Mentor's profile differed from the Helper only in the secondary dimension (Growth vs.\ Resolution). Since the primary experiential driver---joy from enabling others---was identical, the two were merged into the Helper archetype, with the understanding that Helpers may vary in whether their supporting engagement is growth-oriented or resolution-oriented.
\end{itemize}
...
reinforce this engagement, but Creation plays a limited role unless it supports problem 
...
\subsection{Builder}
Builders experience joy through Creation grounded in concreteness and tangible 
progress. Unlike Creators, whose engagement is driven by open-ended 
exploration, Builders find satisfaction in making things work: implementing 
features, wiring components, and producing visible, functional results. Flow 
arises from steady forward movement, where tools remain predictable and 
interruptions are minimal. Growth and Resolution support engagement by 
enabling incremental improvement and problem-solving along the way, but 
conceptual elegance is secondary to functionality. Builders thrive in 
environments that allow for incremental construction, stable toolchains, and 
visible results.
...
Autonomy strongly amplifies their engagement, providing the self-directed 
space that creative work demands. Coherence matters only insofar
...
Synthesizers are driven to integrate diverse ideas into a coherent 
...
reinforce their motivation, as the integrative work often serves both 
conceptual clarity and collaborative value. Resolution supports refinement of 
...
Resolution supports problem-solving for others and is a significant part of the 
Helper's engagement, while personal novelty and autonomy play a lesser role. 
Helpers excel in collaborative environments, code review, 
documentation, and knowledge-sharing roles.

\subsection{Stabilizer}
Stabilizers experience joy primarily through Resolution: ensuring reliability, 
monitoring system behavior, and preventing regressions. Their engagement is 
directed toward Contribution to system stability rather than interpersonal 
support, but the experiential source of joy lies in the resolution process 
itself. Coherence reinforces their work by providing the structural clarity 
that makes maintenance meaningful. Novelty is valued only when it reduces 
future uncertainty. Stabilizers thrive in operational, QA, or 
maintenance-oriented contexts.

\subsection{Explorer}
Explorers derive joy from novelty, experimentation, and boundary-pushing.
Autonomy dominates their profile, with Creation as a strong secondary driver 
and Growth emerging through self-directed discovery. Flow arises when 
constraints are minimal and uncertainty is an invitation rather than an 
obstacle. Coherence matters only after the exploration produces insight. 
Explorers thrive in research, prototyping, and experimental tool work.

\subsection{Strategist}
Strategists experience joy from shaping the direction of systems and 
organizations. Their primary sensitivity is Contribution: the satisfaction of 
influencing trajectories, aligning decisions, and enabling long-term impact. 
This is supported by Coherence, which structures their long-range reasoning, 
and Growth, which reflects the continuous learning involved in anticipating 
consequences and expanding strategic judgment. Resolution plays a supporting 
role in trade-off analysis. Autonomy matters insofar as strategic judgment 
requires independent evaluation. Flow emerges in complex planning tasks, 
architectural evolution, or organizational strategy. Strategists thrive in 
leadership, architecture evolution, and high-level design.

\subsection{Harmonizer}
Harmonizers derive joy from balancing technical, interpersonal, or
organizational tensions. Contribution is their primary driver, supported by 
Coherence and Resolution as strong secondary dimensions: Coherence provides the 
structural lens through which alignment is pursued, while Resolution supports the 
convergence needed to reconcile competing demands. They find satisfaction when 
systems, teams, and practices align. Flow emerges in mediating competing 
constraints or integrating stakeholder needs. Harmonizers excel in roles 
requiring facilitation, coordination, and socio-technical negotiation.
...
Creation, Resolution, and Contribution support their engagement when 
self-determined, but none of these dimensions drives the Autonomist 
independently. Autonomists thrive in environments that provide flexibility, 
trust, and space for individualized workflows.
